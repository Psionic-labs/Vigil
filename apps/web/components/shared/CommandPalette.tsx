...
export function CommandPalette() {
  ...
  return (
    <Command.Dialog
      ...
      overlayClassName="fixed inset-0 z-50 bg-bg/80 backdrop-blur-sm transition-opacity"
      contentClassName="fixed left-1/2 top-[15vh] z-50 w-[calc(100vw-2rem)] max-w-2xl -translate-x-1/2 overflow-hidden rounded-xl border border-border bg-bg shadow-2xl flex flex-col"
    >
