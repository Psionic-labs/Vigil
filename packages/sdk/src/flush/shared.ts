/**
 * @file shared.ts
 * @description Shared queue definitions and scheduled task references for flushes.
 * @why Synchronizes timing configurations between normal and exit flushing routines.
 */
